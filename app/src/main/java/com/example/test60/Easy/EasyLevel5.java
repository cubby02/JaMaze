...
public class EasyLevel5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_level_5);


        chartt= findViewById(R.id.chartt5);
        mazeMap = findViewById(R.id.mazeMap5);
    ...
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(EasyLevel5.this, ActivityEasyLevelSelector.class);
