...
public class HardLevel1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityHardLevel1Binding binding = ActivityHardLevel1Binding.inflate(getLayoutInflater());
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sound.playClick();
                Intent intent = new Intent(HardLevel1.this, MainActivity.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sound.playReset();
                finish();
                startActivity(new Intent(HardLevel1.this, HardLevel1.class));
