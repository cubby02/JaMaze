...
import com.example.test60.databinding.ActivityExtremeLevel3Binding;
import com.google.android.material.dialog.MaterialAlertDialogBuilder;

public class ExtremeLevel3 extends AppCompatActivity {
    ImageView chartt;
    ImageView mazeMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityExtremeLevel3Binding binding = ActivityExtremeLevel3Binding.inflate(getLayoutInflater());
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sound.playClick();
                Intent intent = new Intent(ExtremeLevel3.this, MainActivity.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sound.playReset();
                finish();
                startActivity(new Intent(ExtremeLevel3.this, ExtremeLevel3.class));
