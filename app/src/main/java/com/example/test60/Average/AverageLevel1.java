...
public class AverageLevel1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartt= findViewById(R.id.chartt6);
        mazeMap = findViewById(R.id.mazeMap6);
...
//setting character config
    ...
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(AverageLevel1.this, ActivityAverageLevelSelector.class);
