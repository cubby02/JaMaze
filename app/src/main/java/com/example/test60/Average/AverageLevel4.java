...
public class AverageLevel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartt= findViewById(R.id.chartt9);
        mazeMap = findViewById(R.id.mazeMap9);
...
//setting character config
    ...
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(AverageLevel4.this, ActivityAverageLevelSelector.class);
