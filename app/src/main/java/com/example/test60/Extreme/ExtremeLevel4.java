...
import com.example.test60.databinding.ActivityExtremeLevel4Binding;
import com.google.android.material.dialog.MaterialAlertDialogBuilder;

public class ExtremeLevel4 extends AppCompatActivity {
    ImageView chartt;
    ImageView mazeMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityExtremeLevel4Binding binding = ActivityExtremeLevel4Binding.inflate(getLayoutInflater());
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sound.playClick();
                Intent intent = new Intent(ExtremeLevel4.this, MainActivity.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sound.playReset();
                finish();
                startActivity(new Intent(ExtremeLevel4.this, ExtremeLevel4.class));
