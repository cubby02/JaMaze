...
import com.example.test60.databinding.ActivityHardLevel2Binding;
...
public class HardLevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityHardLevel2Binding binding = ActivityHardLevel2Binding.inflate(getLayoutInflater());
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sound.playClick();
                Intent intent = new Intent(HardLevel2.this, MainActivity.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sound.playReset();
                finish();
                startActivity(new Intent(HardLevel2.this, HardLevel2.class));
