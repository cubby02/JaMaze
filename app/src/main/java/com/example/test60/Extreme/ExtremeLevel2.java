...
import com.example.test60.databinding.ActivityExtremeLevel2Binding;
import com.google.android.material.dialog.MaterialAlertDialogBuilder;

public class ExtremeLevel2 extends AppCompatActivity {
    ImageView chartt;
    ImageView mazeMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityExtremeLevel2Binding binding = ActivityExtremeLevel2Binding.inflate(getLayoutInflater());
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sound.playClick();
                Intent intent = new Intent(ExtremeLevel2.this, MainActivity.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sound.playReset();
                finish();
                startActivity(new Intent(ExtremeLevel2.this, ExtremeLevel2.class));
