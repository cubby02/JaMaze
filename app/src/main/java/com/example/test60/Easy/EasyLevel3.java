...
public class EasyLevel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_level_3);


        chartt= findViewById(R.id.chartt3);
        mazeMap = findViewById(R.id.mazeMap3);
    ...
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(EasyLevel3.this, ActivityEasyLevelSelector.class);
