...
public class AverageLevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartt= findViewById(R.id.chartt7);
        mazeMap = findViewById(R.id.mazeMap7);
...
//setting character config
    ...
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(AverageLevel2.this, ActivityAverageLevelSelector.class);
