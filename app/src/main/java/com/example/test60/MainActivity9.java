...
public class MainActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartt= findViewById(R.id.chartt2);
        mazeMap = findViewById(R.id.mazeMap2);
    ...
    public void  openActivity_Main8() {
        Intent intentLoadNewActivity = new Intent(this, MainActivity8.class);
        startActivity(intentLoadNewActivity);
    }

    @Override
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(MainActivity9.this, MainActivity3.class);
        startActivity(intentLoadNewActivity);
    }
}