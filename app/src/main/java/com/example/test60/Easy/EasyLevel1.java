...
public class EasyLevel1 extends AppCompatActivity {
    ...
    public void  openActivity_Main8() {
       // Intent intentLoadNewActivity = new Intent(this, ActivityQuestions.class);
        //  startActivity(intentLoadNewActivity);
    }

    @Override
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(EasyLevel1.this, ActivityEasyLevelSelector.class);
        startActivity(intentLoadNewActivity);
    }
