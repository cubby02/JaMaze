...
private SoundPlayer sound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityAverageLevel1Binding binding = ActivityAverageLevel1Binding.inflate(getLayoutInflater());
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sound.playClick();
                Intent intent = new Intent(AverageLevel1.this, MainActivity.class);
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sound.playReset();
                finish();
                startActivity(new Intent(AverageLevel1.this, AverageLevel1.class));
