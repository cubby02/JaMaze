...
public class AverageLevel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartt= findViewById(R.id.chartt8);
        mazeMap = findViewById(R.id.mazeMap8);
...
//setting character config
    ...
    public void onBackPressed() {
        Intent intentLoadNewActivity = new Intent(AverageLevel3.this, ActivityAverageLevelSelector.class);
